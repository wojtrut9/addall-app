...
def generate_full_excel(analiza, zam_df, summary):
    ...
    with pd.ExcelWriter(output, engine="openpyxl") as writer:
        ...
        full_cols = [c for c in [
            ...
            "Stan", "w_drodze", "efektywny_stan", "Stan Min.",
            "srednie_dzienne", "dni_do_wyczerpania",
            "wartosc_stanu", "wartosc_w_drodze",
            "ile_zamowic", "wartosc_zamowienia",
...
def _add_summary_sheet(writer, summary):
    ...
    data = {
        "Metryka": [
            "Data analizy",
            "Okres danych",
            "Produktów aktywnych w kartotece (Akt='T')",
            "Z aktywnym ruchem (sprzedaż lub zamówienie u dostawcy)",
            "Wartość magazynu — aktywne pozycje",
            "Wartość całego magazynu (z dead-stockiem)",
            "─────────────",
        ...
        "Wartość": [
            ...
            f"{summary.get('wartosc_calego_magazynu', summary['wartosc_magazynu']):,.0f} PLN".replace(",", " "),
            "",
